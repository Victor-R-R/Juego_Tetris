            ...
            if item =="🔳":
                ...
                match movement:
                    ...
                    case Movement.ROTATE:
                        new_row_index = row_index + rotations[new_rotation][rotations_item][0]
                        new_column_index = column_index + rotations[new_rotation][rotations_item][1]
                        rotations_item += 1
                
                if new_row_index > 9 or new_column_index > 9 or new_column_index < 0:
                    print("\nEstás fuera de los márgenes")
